...
export default function FeedPage() {
  return (
    <main className="relative mx-auto max-w-md">
      {/* Cabeçalho fixo */}
      <div className="pointer-events-none fixed inset-x-0 top-0 z-10 mx-auto flex max-w-md items-center justify-between bg-gradient-to-b from-zinc-950/90 to-transparent px-5 pb-8 pt-4">
